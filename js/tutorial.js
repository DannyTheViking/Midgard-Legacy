...
const TUTORIAL_OBJECTIVES = Object.freeze({
    ...
    4: { title: "Forge Iron Bars", text: "Ask Bjørn at the Village Forge to smelt six Iron Bars. The village supplies the fuel and tools.", progressKey: "iron_bars", target: 6, unit: "Iron Bars", route: "Village → Forge", href: "forge.html", button: "🔥 Open Village Forge", nav: "village.html", card: "forge-building-card" },
    ...
    12: { title: "Fill a Bucket with Fresh Water", text: "Take the remaining Empty Bucket to a fresh-water source. Fill it at a river or well; the Village Well is available now.", progressKey: "water_buckets", target: 1, unit: "Water Bucket", route: "World Map → Village Well", href: "village-well.html", button: "🪣 Visit Village Well", nav: "map.html", card: "well-map-location" },
